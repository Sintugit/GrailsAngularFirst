<div class="page-header">
  <div class="header-links hidden-xs">
    ...
    <div class="dropdown"> <a href="javascript:;" class="header-link clearfix" data-toggle="dropdown">
        <div class="avatar"> 
          <img ng-src="${request.getContextPath()}/images/avatar.png" alt="">
  ...
  <div class="prodList">
    ...
    <div class="dropdown mrlt20"> <a href="javascript:;" class="header-link clearfix" data-toggle="dropdown">
        <div class="user-name-w"> <span class="username">App42 MA</span><i class="fa fa-caret-down ddIcon"></i> </div>
      </a>
      <ul class="dropdown-menu dropdown-inbar">          
        <li class="mrtp10"><a href="${request.getContextPath()}/service" class="b">App42 Cloud API</a></li>
      </ul>
    </div>
  </div>
</div>